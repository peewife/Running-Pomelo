package com.ellison.runningpomelo.viewmodel
...
import com.ellison.runningpomelo.util.DensityUtil
                ...
                emit(when (action) {
                    ...
                    GameAction.AutoTick -> run {
                        ...
                        if (state.gameStatus == GameStatus.Dying) {
                            val newPomeloState = state.pomeloState.quickFall()
                            return@run state.copy(
                                pomeloState = newPomeloState
                            )
                        }
                        ...
                        LogUtil.printLog(message = "AutoTick pipe move & pomelo fall")
                        ...
                        // Pomelo fall.
                        val newPomeloState = state.pomeloState.fall()
                    ...
                    GameAction.TouchLift -> run {
                        ...
                        // Pomelo lift
                        val newPomeloState = state.pomeloState.lift()
                    ...
                    GameAction.ScreenSizeDetect -> run {
                        ...
                        // change pomelo constants.
                        PomeloSizeHeight = PipeDistance * PomeloPipeDistanceFraction
                        PomeloSizeWidth = PomeloSizeHeight * 1.44f
                        ...
                        // reset pomelo state instance
                        val newPomeloState = state.pomeloState.correct()

                        LogUtil.printLog(message = "newPipeStateList:$newPipeStateList + newPomeloState:$newPomeloState")
                    ...
                    GameAction.HitPipe -> run {
                        ...
                        // Pomelo quick fall and wait to hit ground.
                        // Pomelo fall.
                        val newPomeloState = state.pomeloState.quickFall()
