...
import androidx.compose.ui.unit.dp
import com.ellison.runningpomelo.model.HighPipe
import com.ellison.runningpomelo.R
import com.ellison.runningpomelo.model.LowPipe
import com.ellison.runningpomelo.model.MiddlePipe
...
fun PipeCover2() {
    Image(
        painter = painterResource(id = R.drawable.pipe_cover2),
        contentScale = ContentScale.FillBounds,
        contentDescription = null,
        modifier = Modifier.size(PipeCoverWidth, PipeCoverHeight)
    )
