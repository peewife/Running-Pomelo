...
import com.ellison.runningpomelo.util.ScoreFontFamily
import com.ellison.runningpomelo.model.GameStatus
import com.ellison.runningpomelo.model.ViewState
import com.ellison.runningpomelo.ui.theme.GroundDividerPurple
...
fun GameOverBoard(modifier: Modifier, score: Int = 13, maxScore: Int = 100, clickable: Clickable = Clickable()) {
    Box(
        ...
        Column(
            ...
            // Control buttons
            GameOverButton(modifier = Modifier
                .wrapContentSize()
                .align(CenterHorizontally), clickable)
        }
    }
}
