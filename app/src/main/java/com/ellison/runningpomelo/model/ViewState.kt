...
data class ViewState(
    ...
    val pomeloState: PomeloState = PomeloState(),
    ...
    val isLifting get() = gameStatus == GameStatus.Running && pomeloState.isLifting
    val isFalling get() = gameStatus == GameStatus.Running && !pomeloState.isLifting
